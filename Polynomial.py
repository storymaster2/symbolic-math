...
class Coefficient:
    ...
    def __mod__(self, other):
        print(self.primaryVariable)
        #TODO: check whether there are any indeterminate variables
        #implement behavior for simplified forms (no indeterminates, for example)
